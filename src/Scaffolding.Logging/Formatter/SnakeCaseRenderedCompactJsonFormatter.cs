...
internal class SnakeCaseRenderedCompactJsonFormatter(SnakeCaseJsonValueFormatter? valueFormatter = null) : ITextFormatter
{
    private static readonly JsonNamingPolicy _jsonNamingPolicy = JsonNamingPolicy.SnakeCaseLower;
    private readonly SnakeCaseJsonValueFormatter _valueFormatter = valueFormatter ?? new SnakeCaseJsonValueFormatter(_jsonNamingPolicy, "$type");
